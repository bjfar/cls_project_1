...
import clstools.numberprettyprinter as ppn
...
SR1_0lep = tools.Experiment(name='SR1_0lep', o=15, ssys=0.3, b=17.5, bsys=0.18, sK=1., outdir='results')
SR2_0lep = tools.Experiment(name='SR2_0lep', o=2 , ssys=0.3, b= 4.7, bsys=0.33, sK=1., outdir='results')
SR3_0lep = tools.Experiment(name='SR3_0lep', o=1 , ssys=0.3, b= 2.7, bsys=0.45, sK=1., outdir='results')
...
# "For the signal prediction, the systematic uncertainty is approximately 30%, constant across the plane of top squark and LSP masses. The uncertainty is dominated by the uncertainties on the jet energy scale (25%) and b-tagging (15%) as well as by the theoretical uncertainties on the cross section (14%).
# tuning notes: Observed limit is being overestimated, so turning down the signal efficiency scaling parameter
SRtN2_1lep = tools.Experiment(name='SRtN2_1lep', o=14 , ssys=0.05, b=13. , bsys=3./13.  , sK=1., outdir='results')
SRtN3_1lep = tools.Experiment(name='SRtN3_1lep', o=7  , ssys=0.06, b=5.  , bsys=2./5.   , sK=1., outdir='results')

SRbC1_1lep = tools.Experiment(name='SRbC1_1lep', o=456, ssys=0.05, b=482., bsys=76./482., sK=1., outdir='results')
SRbC2_1lep = tools.Experiment(name='SRbC2_1lep', o=25 , ssys=0.05, b=18. , bsys=5./18.  , sK=1., outdir='results')
SRbC3_1lep = tools.Experiment(name='SRbC3_1lep', o=6  , ssys=0.05, b=7.  , bsys=3./7.   , sK=1., outdir='results')

# Only the 3 most constraining bins of the shape data are used in the ATLAS fit
# (data in top row of figure 2)
SRtN1shape1_1lep = tools.Experiment(name='SRtN1.shape(1)_1lep', o=253, ssys=0.05, b=250., bsys=57./250., sK=1 , outdir='results')
SRtN1shape2_1lep = tools.Experiment(name='SRtN1.shape(2)_1lep', o=165, ssys=0.05, b=174., bsys=28./174., sK=1., outdir='results')
SRtN1shape3_1lep = tools.Experiment(name='SRtN1.shape(3)_1lep', o=235, ssys=0.05, b=262., bsys=34./262., sK=1., outdir='results')
...
# "For the signal prediction, the systematic uncertainty is approximately 30%, constant across the plane of top squark and LSP masses. The uncertainty is dominated by the uncertainties on the jet energy scale (25%) and b-tagging (15%) as well as by the theoretical uncertainties on the cross section (14%).
# tuning notes: Observed limit is being overestimated, so turning down the signal efficiency scaling parameter
SRM90_2lep  = tools.Experiment(name='SRM90_2lep' , o=260, ssys=0.2, b=300., bsys=40./300., sK=1., outdir='results')
SRM100_2lep = tools.Experiment(name='SRM100_2lep', o=3  , ssys=0.2, b=4.8 , bsys=2.2/4.8 , sK=1., outdir='results')
SRM110_2lep = tools.Experiment(name='SRM110_2lep', o=7  , ssys=0.2, b=11. , bsys=4./11.  , sK=1., outdir='results')
SRM120_2lep = tools.Experiment(name='SRM120_2lep', o=3  , ssys=0.2, b=4.3 , bsys=1.3/4.3 , sK=1., outdir='results')
...
# "For the signal prediction, the systematic uncertainty is approximately 30%, constant across the plane of top squark and LSP masses. The uncertainty is dominated by the uncertainties on the jet energy scale (25%) and b-tagging (15%) as well as by the theoretical uncertainties on the cross section (14%).
# tuning notes: Observed limit is being overestimated, so turning down the signal efficiency scaling parameter
SRA150_2b = tools.Experiment(name='SRA150_2b', o=102, ssys=0.2, b=94. , bsys=13./94. , sK=1., outdir='results')
SRA200_2b = tools.Experiment(name='SRA200_2b', o=48 , ssys=0.2, b=39. , bsys=6./39.  , sK=1., outdir='results')
SRA250_2b = tools.Experiment(name='SRA250_2b', o=14 , ssys=0.3, b=15.8, bsys=2.8/15.8, sK=1., outdir='results')
SRA300_2b = tools.Experiment(name='SRA300_2b', o=7  , ssys=0.2, b=5.9 , bsys=1.1/5.9 , sK=1., outdir='results')
SRA350_2b = tools.Experiment(name='SRA350_2b', o=3  , ssys=0.2, b=2.5 , bsys=0.6/2.5 , sK=1., outdir='results')
SRB_2b    = tools.Experiment(name='SRB_2b'   , o=65 , ssys=0.2, b=64. , bsys=10./64. , sK=1., outdir='results')
